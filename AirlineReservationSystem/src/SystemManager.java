...
public class SystemManager {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (desiredOption == 1) {
                ...
                handleAdminResister(am1);
            }
            else if (desiredOption == 3) {
                handleCustomerLogin(read1,read, f1, bookingAndReserving, c1);
            }
    ...
    private static void handleCustomerLogin(Scanner read1, Scanner read, FlightManager f1, FlightReservation bookingAndReserving, CustomerManager c1) {
    ...
    private static void handleAdminResister(AdminManager am1){
        /*
